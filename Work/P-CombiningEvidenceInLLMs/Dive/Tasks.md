...
- [ ] #task Implement a factory pattern for the components (*extractor, data_generator, bpa_assigner, etc*) by having a function i
- [ ] #task Use the google-genai idiomatic way of setting system prompts, inference properties e.g. top-p, temp. see https://googleapis.github.io/python-genai/#system-instructions-and-other-configs
